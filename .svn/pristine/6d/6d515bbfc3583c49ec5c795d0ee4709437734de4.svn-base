...
/**
  ...
  */
@deprecated
object Thread4ITMDataCollect3 extends Serializable {
  @transient
  ...
  def main(args: Array[String]) {
    ...
    resultList.foreachRDD(rdd => {
      ...
      logger.info("===== list ==>" + list.mkString(","))
      ...
      logger.warn("------------  当前strkeam数据保存处理耗时dataAcceptAndSaveMysql  ------------：" + (endSave - rddCollectEnd) + "ms")
    })
    ssc.start()
